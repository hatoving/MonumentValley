...
xdelta3.exe -d -s "ANDROID/assets/bin/Data/Managed/Assembly-CSharp.dll" PHONE_PATCHES/gamedata/code/Assembly-CSharp.dll.xdelta patchedFiles/Media/Managed/Assembly-CSharp.dll
echo Done! 
pause